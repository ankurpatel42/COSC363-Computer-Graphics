...
void wagon()
{
    ...
    glBegin(GL_QUADS);
      ...
      glTexCoord2f(0, 0);
      glVertex3f(-35.0, 5.0, 6.0); // -----------------------------------> bottom left vertex of plane
      glTexCoord2f(1, 0);
      glVertex3f(35.0, 5.0, 6.0); // ------------------------------------> bottom right vertex of plane
      glTexCoord2f(1, 0.33984375);
      glVertex3f(35.0, 17.0, 6.0); // ------------------------------------> top right vertex of plane
      glTexCoord2f(0, 0.33984375);
      glVertex3f(-35.0, 17.0, 6.0); //---------------------------------------> top left vertex of plane
