...
void display()
{
    ...
    glPushMatrix();
    glTranslatef(38.88, 64, 0);    //sphere
    glutSolidSphere(sphere_x, sphere_y, sphere_z);
    glPopMatrix();

    glPushMatrix();             // left rectangle
...
void cannonTimer(int value)
{
    if (value < 600) {
        ...
        glutPostRedisplay();
        value++;
        glutTimerFunc(250, cannonTimer, value);
    }
}
...
int main(int argc, char** argv)
{
   ...
   glutTimerFunc(250, cannonTimer, 0);
